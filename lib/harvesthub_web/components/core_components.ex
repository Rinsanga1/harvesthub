defmodule HarvesthubWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HarvesthubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HarvesthubWeb.Gettext, "errors", msg, opts)
    end
  end
